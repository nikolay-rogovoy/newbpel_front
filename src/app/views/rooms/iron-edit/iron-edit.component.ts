...
@LoadFormDecorator(EntityName.iron, () => of({ idiron: null, dtcre: new Date(), active: true }))
@SubmitFormDecorator(EntityName.iron)
@DeleteFormDecorator(EntityName.iron)
@ExistsEntityFormDecorator()
@CancelFormDecorator()
@InvalidControlFormDecorator()
export class IronEditComponent extends LifecycleComponent implements IReactiveForm, OnInit {
