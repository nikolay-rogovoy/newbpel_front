...
@Component({
  templateUrl: 'extraroom-edit.component.html'
})
@ReactiveFormDecorator()
@LoadFormDecorator(EntityName.extraroom, () => of({ idextraroom: null, dtcre: new Date(), active: true }))
@SubmitFormDecorator(EntityName.extraroom)
@DeleteFormDecorator(EntityName.extraroom)
@ExistsEntityFormDecorator()
@CancelFormDecorator()
@InvalidControlFormDecorator()
export class ExtraroomEditComponent extends LifecycleComponent implements IReactiveForm, OnInit {

  formGroup = new FormGroup({
    idextraroom: new FormControl(''),
