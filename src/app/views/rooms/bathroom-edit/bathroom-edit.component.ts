...
@Component({
  templateUrl: 'bathroom-edit.component.html'
})
@ReactiveFormDecorator()
@LoadFormDecorator(EntityName.bathroom, () => of({ idbathroom: null, dtcre: new Date(), active: true }))
@SubmitFormDecorator(EntityName.bathroom)
@DeleteFormDecorator(EntityName.bathroom)
@ExistsEntityFormDecorator()
@CancelFormDecorator()
@InvalidControlFormDecorator()
export class BathroomEditComponent extends LifecycleComponent implements IReactiveForm, OnInit {

  formGroup = new FormGroup({
    idbathroom: new FormControl(''),
