...
@Component({
  templateUrl: 'internets-select.component.html'
})
@LoadActiveListDecorator(EntityName.internet)
export class InternetsSelectComponent extends LifecycleComponent implements IListSelectComponent<Internet>, OnInit {

  positions: Internet[] = [];

  gridMetaData: ColumnInfo[] = [
    new ColumnInfo('name', 'Internet name', true, new FilterInfo(''), ColumnFormat.Default, false),
    new ColumnInfo('comment', 'Comment', true, new FilterInfo(''), ColumnFormat.Default, false),
  ];

  @Output()
  selection = new EventEmitter<Internet>();
