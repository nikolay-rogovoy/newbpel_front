...
@LoadFormDecorator(EntityName.tv, () => of({ idtv: null, dtcre: new Date(), active: true }))
@SubmitFormDecorator(EntityName.tv)
@DeleteFormDecorator(EntityName.tv)
@ExistsEntityFormDecorator()
@CancelFormDecorator()
@InvalidControlFormDecorator()
export class TvEditComponent extends LifecycleComponent implements IReactiveForm, OnInit {
