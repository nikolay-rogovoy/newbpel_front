...
@Component({
  templateUrl: 'hygienekit-edit.component.html'
})
@ReactiveFormDecorator()
@LoadFormDecorator(EntityName.hygienekit, () => of({ idhygienekit: null, dtcre: new Date(), active: true }))
@SubmitFormDecorator(EntityName.hygienekit)
@DeleteFormDecorator(EntityName.hygienekit)
@ExistsEntityFormDecorator()
@CancelFormDecorator()
@InvalidControlFormDecorator()
export class HygienekitEditComponent extends LifecycleComponent implements IReactiveForm, OnInit {
