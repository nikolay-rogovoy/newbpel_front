...
@LoadListDecorator(EntityName.kitchen)
@SelectRowDecorator(EntityName.kitchen)
@CreateDecorator(EntityName.kitchen)
export class KitchensComponent extends LifecycleComponent implements IListComponent<Kitchen>, OnInit {
  ...
  gridMetaData: ColumnInfo[] = [
    new ColumnInfo('name', 'Kitchen', true, new FilterInfo(''), ColumnFormat.Default, false),
