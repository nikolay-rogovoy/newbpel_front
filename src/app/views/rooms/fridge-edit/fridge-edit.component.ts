...
@LoadFormDecorator(EntityName.fridge, () => of({ idfridge: null, dtcre: new Date(), active: true }))
@SubmitFormDecorator(EntityName.fridge)
@DeleteFormDecorator(EntityName.fridge)
@ExistsEntityFormDecorator()
@CancelFormDecorator()
@InvalidControlFormDecorator()
export class FridgeEditComponent extends LifecycleComponent implements IReactiveForm, OnInit {
