...
@LoadFormDecorator(EntityName.kitchen, () => of({ idkitchen: null, dtcre: new Date(), active: true }))
@SubmitFormDecorator(EntityName.kitchen)
@DeleteFormDecorator(EntityName.kitchen)
@ExistsEntityFormDecorator()
@CancelFormDecorator()
@InvalidControlFormDecorator()
export class KitchenEditComponent extends LifecycleComponent implements IReactiveForm, OnInit {
