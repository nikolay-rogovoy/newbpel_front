...
@Component({
  templateUrl: 'tempcontrol-edit.component.html'
})
@ReactiveFormDecorator()
@LoadFormDecorator(EntityName.tempcontrol, () => of({ idtempcontrol: null, dtcre: new Date(), active: true }))
@SubmitFormDecorator(EntityName.tempcontrol)
@DeleteFormDecorator(EntityName.tempcontrol)
@ExistsEntityFormDecorator()
@CancelFormDecorator()
@InvalidControlFormDecorator()
export class TempcontrolEditComponent extends LifecycleComponent implements IReactiveForm, OnInit {
