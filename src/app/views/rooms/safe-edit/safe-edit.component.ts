...
@LoadFormDecorator(EntityName.safe, () => of({ idsafe: null, dtcre: new Date(), active: true }))
@SubmitFormDecorator(EntityName.safe)
@DeleteFormDecorator(EntityName.safe)
@ExistsEntityFormDecorator()
@CancelFormDecorator()
@InvalidControlFormDecorator()
export class SafeEditComponent extends LifecycleComponent implements IReactiveForm, OnInit {
