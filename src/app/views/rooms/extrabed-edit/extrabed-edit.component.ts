...
@Component({
  templateUrl: 'extrabed-edit.component.html'
})
@ReactiveFormDecorator()
@LoadFormDecorator(EntityName.extrabed, () => of({ idextrabed: null, dtcre: new Date(), active: true }))
@SubmitFormDecorator(EntityName.extrabed)
@DeleteFormDecorator(EntityName.extrabed)
@ExistsEntityFormDecorator()
@CancelFormDecorator()
@InvalidControlFormDecorator()
export class ExtrabedEditComponent extends LifecycleComponent implements IReactiveForm, OnInit {
