...
@LoadFormDecorator(EntityName.bed, () => of({ idbed: null, dtcre: new Date(), active: true }))
@SubmitFormDecorator(EntityName.bed)
@DeleteFormDecorator(EntityName.bed)
@ExistsEntityFormDecorator()
@CancelFormDecorator()
@InvalidControlFormDecorator()
export class BedEditComponent extends LifecycleComponent implements IReactiveForm, OnInit {
