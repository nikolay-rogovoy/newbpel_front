...
@Component({
  templateUrl: 'extrabeds.component.html'
})
@LoadListDecorator(EntityName.extrabed)
@SelectRowDecorator(EntityName.extrabed)
@CreateDecorator(EntityName.extrabed)
export class ExtrabedsComponent extends LifecycleComponent implements IListComponent<Extrabed>, OnInit {
  ...
  gridMetaData: ColumnInfo[] = [
    new ColumnInfo('name', 'Extrabed', true, new FilterInfo(''), ColumnFormat.Default, false),
