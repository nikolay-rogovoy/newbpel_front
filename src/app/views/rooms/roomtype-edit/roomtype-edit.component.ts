...
@LoadFormDecorator(EntityName.roomtype, () => of({ idroomtype: null, dtcre: new Date(), active: true }))
@SubmitFormDecorator(EntityName.roomtype)
@DeleteFormDecorator(EntityName.roomtype)
@ExistsEntityFormDecorator()
@CancelFormDecorator()
@InvalidControlFormDecorator()
export class RoomtypeEditComponent extends LifecycleComponent implements IReactiveForm, OnInit {
