...
@Component({
  templateUrl: 'internet-edit.component.html'
})
@ReactiveFormDecorator()
@LoadFormDecorator(EntityName.internet, () => of({ idinternet: null, dtcre: new Date(), active: true }))
@SubmitFormDecorator(EntityName.internet)
@DeleteFormDecorator(EntityName.internet)
@ExistsEntityFormDecorator()
@CancelFormDecorator()
@InvalidControlFormDecorator()
export class InternetEditComponent extends LifecycleComponent implements IReactiveForm, OnInit {
