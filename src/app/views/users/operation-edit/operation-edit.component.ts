...
@LoadFormDecorator(EntityName.operation, () => of({ idoperation: null, dtcre: new Date(), active: true }))
@SubmitFormDecorator(EntityName.operation)
@DeleteFormDecorator(EntityName.operation)
@ExistsEntityFormDecorator()
@CancelFormDecorator()
@InvalidControlFormDecorator()
export class OperationEditComponent extends LifecycleComponent implements IReactiveForm, OnInit {
