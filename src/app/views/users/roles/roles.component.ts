...
@LoadListDecorator(EntityName.role)
@SelectRowDecorator(EntityName.role)
@CreateDecorator(EntityName.role)
export class RolesComponent extends LifecycleComponent implements IListComponent<Role>, OnInit {
