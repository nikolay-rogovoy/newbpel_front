...
@LoadListDecorator(EntityName.resource)
@SelectRowDecorator(EntityName.resource)
@CreateDecorator(EntityName.resource)
export class ResourcesComponent extends LifecycleComponent implements IListComponent<Resource>, OnInit {
